classdef VS_testIntensities < VStim
    ...
    methods
        function obj=run(obj)
            ...
            for i=1:obj.nTotTrials
                ...
                WaitSecs(obj.waitBeforeLight);
                obj.sendTTL(1,true); %session start trigger, light the flashlight
                ...
                obj.sendTTL(1,false); %turn off flash light before switching to next intensity
        ...
        %class constractor
        function obj=VS_testIntensities(w,h)
